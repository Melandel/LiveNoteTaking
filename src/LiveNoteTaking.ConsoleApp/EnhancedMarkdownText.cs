record EnhancedMarkdownText
{
	...
	public static EnhancedMarkdownText From(string encapsulated)
	{
		...
		{
			var objectConstructionException = ObjectConstructionException.FromDeveloperMistake(typeof(EnhancedMarkdownText), developerMistake);
			AddMethodParametersValuesAsDebuggingInformation(objectConstructionException);
	...
	public record DiagrammingEnhancement
	{
		...
		public record Plantuml { public const string StartToken = "```puml"; }
