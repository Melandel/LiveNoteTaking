class FileUpdateNotifier : IDisposable
{
		...
		NotificationMechanism<FileUpdateNotification> notificationMechanism)
	{
		...
		{
			var objectConstructionException = ObjectConstructionException.FromDeveloperMistake(typeof(FileUpdateNotifier), developerMistake);
			AddMethodParametersValuesAsDebuggingInformation(objectConstructionException);
		...
		{
			objectConstructionException.AddDebuggingInformation(nameof(filepath), filepath);
			objectConstructionException.AddDebuggingInformation(nameof(notificationMechanism), notificationMechanism);
		}
	}
