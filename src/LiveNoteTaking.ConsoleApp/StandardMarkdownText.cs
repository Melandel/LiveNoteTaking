...
record StandardMarkdownText
{
	...
	public static StandardMarkdownText From(StringBuilder stringBuilder)
	{
		...
		{
			var objectConstructionException = ObjectConstructionException.FromDeveloperMistake(typeof(StandardMarkdownText), developerMistake);
			AddMethodParametersValuesAsDebuggingInformation(objectConstructionException);
		...
		{
			objectConstructionException.AddDebuggingInformation(nameof(stringBuilder), stringBuilder);
		}
	}
